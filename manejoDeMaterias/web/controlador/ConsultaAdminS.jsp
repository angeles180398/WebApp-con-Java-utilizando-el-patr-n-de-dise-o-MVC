...
<table width="25%">
    <tr>
        <td colspan="2" align="center">
          ...
          <input type="submit" name="button" id="button" value="Insertat Materia">
          </form>
      
      </td>
<td colspan="2" align="center">
          <form action="irEditar.html" method="get">
          <input type="submit" name="button" id="button" value="Editar Materia">
          </form>
      ...
      <td colspan="2" align="center">
          ...
          <input type="submit" name="button" id="button" value="Borrar Materia">
          </form>
      
      </td>
      <td colspan="2" align="center">
          <form action="ConsultaAdminU.jsp" method="get">
          <input type="submit" name="button" id="button" value=" Revisar USUARIOS ">
          </form>
